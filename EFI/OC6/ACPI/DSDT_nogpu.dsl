 ...
 *
 * Disassembly of ./DSDT.aml, Wed Sep 16 15:49:33 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00013F9F (81823)
 *     Revision         0x02
 *     Checksum         0xFE
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.PCI0.GFX0.AINT, MethodObj)    // 1 Arguments (from opcode)
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7B23D698, 0x0635)
    ...
    OperationRegion (OGNS, SystemMemory, 0x7B23EF18, 0x0E)
    ...
    Scope (\_PR_.CPU0)
    {
        Name (APLF, Zero)
        Name (APSN, 0x28)
        Name (APSS, Package (0x3B)
        {
            /* High Frequency Modes (turbo) */
            Package (0x06) { 0x189C, 0x003A98, 0x0A, 0x0A, 0x3F00, 0x3F00 },
            Package (0x06) { 0x1838, 0x003A98, 0x0A, 0x0A, 0x3E00, 0x3E00 },
            Package (0x06) { 0x17D4, 0x003A98, 0x0A, 0x0A, 0x3D00, 0x3D00 },
            Package (0x06) { 0x1770, 0x003A98, 0x0A, 0x0A, 0x3C00, 0x3C00 },
            Package (0x06) { 0x170C, 0x003A98, 0x0A, 0x0A, 0x3B00, 0x3B00 },
            Package (0x06) { 0x16A8, 0x003A98, 0x0A, 0x0A, 0x3A00, 0x3A00 },
            Package (0x06) { 0x1644, 0x003A98, 0x0A, 0x0A, 0x3900, 0x3900 },
            Package (0x06) { 0x15E0, 0x003A98, 0x0A, 0x0A, 0x3800, 0x3800 },
            Package (0x06) { 0x157C, 0x003A98, 0x0A, 0x0A, 0x3700, 0x3700 },
            Package (0x06) { 0x1518, 0x003A98, 0x0A, 0x0A, 0x3600, 0x3600 },
            Package (0x06) { 0x14B4, 0x003A98, 0x0A, 0x0A, 0x3500, 0x3500 },
            Package (0x06) { 0x1450, 0x003A98, 0x0A, 0x0A, 0x3400, 0x3400 },
            Package (0x06) { 0x13EC, 0x003A98, 0x0A, 0x0A, 0x3300, 0x3300 },
            Package (0x06) { 0x1388, 0x003A98, 0x0A, 0x0A, 0x3200, 0x3200 },
            Package (0x06) { 0x1324, 0x003A98, 0x0A, 0x0A, 0x3100, 0x3100 },
            Package (0x06) { 0x12C0, 0x003A98, 0x0A, 0x0A, 0x3000, 0x3000 },
            Package (0x06) { 0x125C, 0x003A98, 0x0A, 0x0A, 0x2F00, 0x2F00 },
            Package (0x06) { 0x11F8, 0x003A98, 0x0A, 0x0A, 0x2E00, 0x2E00 },
            Package (0x06) { 0x1194, 0x003A98, 0x0A, 0x0A, 0x2D00, 0x2D00 },
            Package (0x06) { 0x1130, 0x003A98, 0x0A, 0x0A, 0x2C00, 0x2C00 },
            Package (0x06) { 0x10CC, 0x003A98, 0x0A, 0x0A, 0x2B00, 0x2B00 },
            Package (0x06) { 0x1068, 0x003A98, 0x0A, 0x0A, 0x2A00, 0x2A00 },
            Package (0x06) { 0x1004, 0x003A98, 0x0A, 0x0A, 0x2900, 0x2900 },
    ...
    OperationRegion (LGNS, SystemMemory, 0x7B227000, 0x05)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0x7B246C98, 0x0200)
